...
class MeasurementProvider:
  ...
  def get_random2(self, size = 100) -> List[List[Measurement]]:
    signal_generators = [
      SignalGenerator(0, size).noise(),
      ...
      SignalGenerator(0, size).linear(1),
      SignalGenerator(0, size).linear(2),
      SignalGenerator(0, size).linear(1).noise(),
      SignalGenerator(0, size).linear(2).noise(),
      SignalGenerator(0, size).linear(1).sin(0.2, 0.2),
      SignalGenerator(0, size).linear(2).sin(0.2, 0.2),
      SignalGenerator(0, size).linear(1).with_peaks(3).with_peaks(3, direction=-1),
      SignalGenerator(0, size).linear(2).with_peaks(3).with_peaks(3, direction=-1),
      SignalGenerator(0, size).linear(1).with_peaks(3).with_peaks(3, direction=-1).noise(),
      SignalGenerator(0, size).linear(2).with_peaks(3).with_peaks(3, direction=-1).noise(),
      SignalGenerator(0, size).linear(1).sin(0.2, 0.2).noise(),
      SignalGenerator(0, size).linear(2).sin(0.2, 0.2).noise(),
      SignalGenerator(0, size).linear(-1),
      SignalGenerator(0, size).linear(-2),
      SignalGenerator(0, size).linear(-1).noise(),
      SignalGenerator(0, size).linear(-2).noise(),
      ...
      SignalGenerator(0, size).linear(-1).sin(0.2, 0.2).noise(),
      SignalGenerator(0, size).linear(-2).sin(0.2, 0.2).noise(),
      SignalGenerator(0, size).linear(0.1),
      SignalGenerator(0, size).linear(0.2),
      SignalGenerator(0, size).linear(0.1).noise(),
      SignalGenerator(0, size).linear(0.2).noise(),
      SignalGenerator(0, size).linear(0.1).sin(0.2, 0.2),
      SignalGenerator(0, size).linear(0.2).sin(0.2, 0.2),
      SignalGenerator(0, size).linear(0.1).with_peaks(3).with_peaks(3, direction=-1),
      SignalGenerator(0, size).linear(0.2).with_peaks(3).with_peaks(3, direction=-1),
      SignalGenerator(0, size).linear(0.1).with_peaks(3).with_peaks(3, direction=-1).noise(),
      SignalGenerator(0, size).linear(0.2).with_peaks(3).with_peaks(3, direction=-1).noise(),
      SignalGenerator(0, size).linear(0.1).sin(0.2, 0.2).noise(),
      SignalGenerator(0, size).linear(0.2).sin(0.2, 0.2).noise(),
  ...
  def get_random3(self, size=100) -> List[List[Measurement]]:
    signal_generators = [
      SignalGenerator(0, size).linear(1),
      SignalGenerator(0, size).linear(2),
      SignalGenerator(0, size).linear(1).noise(),
